"""
Test Partners/Agents Module for SBPAYGO
...
EXISTING_PARTNER = {"email": "testagent@sbpaygo.com", "password": "testpassword123"}
ADMIN_USER = {"email": "admin@sbpaygo.com", "password": "adminpassword"}
TEST_USER = {"email": "user@sbpaygo.com", "password": "userpassword"}
...
class TestPartnerRegistration:
    ...
    def test_register_new_partner(self):
        ...
        payload = {
            ...
            "email": f"test_partner_{unique_id}@sbpaygo.com",
    ...
    def test_register_duplicate_email(self):
        ...
        payload = {
            "business_name": f"TEST_Boutique_{unique_id}",
            "owner_name": f"TEST_Owner_{unique_id}",
            "email": f"test_dup_{unique_id}@sbpaygo.com",
...
class TestPartnerLogin:
    ...
    def test_login_pending_partner(self):
        ...
        register_payload = {
            ...
            "owner_name": f"TEST_Owner_{unique_id}",
            "email": f"test_pending_{unique_id}@sbpaygo.com",
    ...
    def test_login_missing_fields(self):
        ...
        payload = {"email": "test@sbpaygo.com"}  # Missing password
...
class TestAdminPartnerManagement:
    ...
    def test_admin_activate_partner(self, admin_token):
        ...
        register_payload = {
            ...
            "owner_name": f"TEST_Owner_{unique_id}",
            "email": f"test_activate_{unique_id}@sbpaygo.com",
    ...
    def test_admin_suspend_partner(self, admin_token):
        ...
        register_payload = {
            ...
            "owner_name": f"TEST_Owner_{unique_id}",
            "email": f"test_suspend_{unique_id}@sbpaygo.com",
...
class TestPartnerDashboard:
    ...
    def active_partner_token(self):
        ...
        register_payload = {
            ...
            "owner_name": f"TEST_Owner_{unique_id}",
            "email": f"test_dashboard_{unique_id}@sbpaygo.com",
...
class TestWithdrawalFlow:
    ...
    def setup_withdrawal_test(self):
        ...
        # Register partner
        unique_id = str(uuid.uuid4())[:8]
        partner_email = f"test_withdrawal_{unique_id}@sbpaygo.com"
        register_payload = {
