...
MOBILE_MONEY_PROVIDERS = {
    "SN": [
        {"code": "wave", "name": "Wave", "logo": "🌊", "min": 500, "max": 1000000, "fee_percent": 1.0},
        {"code": "orange_money", "name": "Orange Money", "logo": "🟠", "min": 500, "max": 500000, "fee_percent": 1.5},
        {"code": "free_money", "name": "Free Money", "logo": "🔵", "min": 500, "max": 300000, "fee_percent": 1.2}
    ],
    "CI": [
        {"code": "wave", "name": "Wave", "logo": "🌊", "min": 500, "max": 1000000, "fee_percent": 1.0},
        {"code": "orange_money", "name": "Orange Money", "logo": "🟠", "min": 500, "max": 500000, "fee_percent": 1.5},
        {"code": "mtn_momo", "name": "MTN Mobile Money", "logo": "🟡", "min": 500, "max": 500000, "fee_percent": 1.5},
        {"code": "moov_money", "name": "Moov Money", "logo": "🔴", "min": 500, "max": 300000, "fee_percent": 1.3}
    ],
    "ML": [
        {"code": "orange_money", "name": "Orange Money", "logo": "🟠", "min": 500, "max": 500000, "fee_percent": 1.5},
        {"code": "moov_money", "name": "Moov Money", "logo": "🔴", "min": 500, "max": 300000, "fee_percent": 1.3}
    ...
    "TG": [
        {"code": "flooz", "name": "Flooz", "logo": "🟢", "min": 500, "max": 300000, "fee_percent": 1.5},
        {"code": "tmoney", "name": "T-Money", "logo": "🔵", "min": 500, "max": 300000, "fee_percent": 1.5}
    ],
    "CM": [
        {"code": "orange_money", "name": "Orange Money", "logo": "🟠", "min": 500, "max": 500000, "fee_percent": 1.5},
        {"code": "mtn_momo", "name": "MTN Mobile Money", "logo": "🟡", "min": 500, "max": 500000, "fee_percent": 1.5}
    ...
    "GH": [
        {"code": "mtn_momo", "name": "MTN Mobile Money", "logo": "🟡", "min": 1, "max": 50000, "fee_percent": 1.0},
        {"code": "vodafone_cash", "name": "Vodafone Cash", "logo": "🔴", "min": 1, "max": 50000, "fee_percent": 1.2},
        {"code": "airteltigo", "name": "AirtelTigo Money", "logo": "🔵", "min": 1, "max": 30000, "fee_percent": 1.3}
    ],
    "NG": [
        {"code": "opay", "name": "OPay", "logo": "🟢", "min": 100, "max": 5000000, "fee_percent": 0.5},
        {"code": "palmpay", "name": "PalmPay", "logo": "🟣", "min": 100, "max": 5000000, "fee_percent": 0.5},
        {"code": "kuda", "name": "Kuda", "logo": "🟣", "min": 100, "max": 5000000, "fee_percent": 0.5}
    ],
    "KE": [
        {"code": "mpesa", "name": "M-Pesa", "logo": "🟢", "min": 10, "max": 300000, "fee_percent": 0.5},
        {"code": "airtel_money", "name": "Airtel Money", "logo": "🔴", "min": 10, "max": 200000, "fee_percent": 0.8}
    ],
...
WITHDRAWAL_METHODS = {
    "SN": ["bank", "mobile_money", "agent"],
    "CI": ["bank", "mobile_money", "agent"],
    "ML": ["bank", "mobile_money", "agent"],
    "BF": ["bank", "mobile_money", "agent"],
    "BJ": ["bank", "mobile_money", "agent"],
    "TG": ["bank", "mobile_money", "agent"],
    "CM": ["bank", "mobile_money", "agent"],
    "GH": ["bank", "mobile_money", "card", "agent"],
    "NG": ["bank", "mobile_money", "card", "agent"],
    "KE": ["bank", "mobile_money", "card", "agent"],
    "FR": ["bank", "card"],
    "US": ["bank", "card"],
    "GB": ["bank", "card"],
    "DE": ["bank", "card"],
