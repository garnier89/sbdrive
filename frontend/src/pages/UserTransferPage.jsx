      ...
      <div className="p-6 lg:p-8 max-w-2xl mx-auto" data-testid="user-transfer-page">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Envoyez de l'argent instantanément à d'autres utilisateurs SBPAYGO via leur numéro de téléphone
          </p>
        </div>
        ...
        <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-green-700 dark:text-green-300">
              Les transferts entre utilisateurs SBPAYGO sont gratuits et instantanés.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <Card data-testid="phone-search-card">
              <CardHeader>
                ...
                <CardDescription>
                  Entrez le numéro de téléphone d'un utilisateur SBPAYGO
                </CardDescription>
              </CardHeader>
                  ...
                  <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex items-center gap-3"
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-600 dark:text-green-400">
                        Utilisateur SBPAYGO vérifié • {recipientInfo.phone_masked}
                      </p>
                    </div>
                  </div>
                )}
