      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">
            Retirez de l'argent chez un agent partenaire SBPAYGO
          </p>
        </div>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Rendez-vous chez un point de retrait SBPAYGO près de chez vous
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Les agents partenaires SBPAYGO sont disponibles dans les boutiques, 
                  tabacs et points de vente affichant le logo SBPAYGO.
                </p>
              </div>
            </div>
          </CardContent>
