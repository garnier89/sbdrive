...
export default function PartnerLoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store partner token
      localStorage.setItem('sbpay_partner_token', response.data.access_token);
      localStorage.setItem('sbpay_partner', JSON.stringify(response.data.partner));
        ...
        <Card className="bg-slate-800 border-slate-700">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-slate-400">
              Connectez-vous à votre compte agent SB Pay
            </CardDescription>
          </CardHeader>
          <CardContent>
