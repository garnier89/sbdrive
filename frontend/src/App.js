...
// WhatsAppButton removed - now in footer contact section
        ...
        <AuthProvider>
          <BrowserRouter>
            ...
            <Route path="/saved-cards" element={
              <ProtectedRoute><SavedCardsPage /></ProtectedRoute>
            } />
            <Route path="/geo-security" element={
              <ProtectedRoute><GeoSecurityPage /></ProtectedRoute>
            } />
            ...
            <Route path="/admin/alerts" element={
              <ProtectedRoute adminOnly><AdminAlertsPage /></ProtectedRoute>
            } />
            <Route path="/admin/notifications" element={
              <ProtectedRoute adminOnly><AdminNotificationsPage /></ProtectedRoute>
            } />
            ...
            <Route path="/admin/rewards" element={
              <ProtectedRoute adminOnly><AdminRewardsPage /></ProtectedRoute>
            } />
            <Route path="/admin/zones-config" element={
              <ProtectedRoute adminOnly><AdminZonesConfigPage /></ProtectedRoute>
            } />
            <Route path="/admin/staff" element={
              <ProtectedRoute adminOnly><AdminStaffPage /></ProtectedRoute>
            } />
            <Route path="/admin/commissions" element={
              <ProtectedRoute adminOnly><AdminCommissionsPage /></ProtectedRoute>
            } />
