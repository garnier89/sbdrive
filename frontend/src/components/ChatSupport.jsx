...
const WHATSAPP_MESSAGE = 'Bonjour, j\'ai une question concernant SBPAYGO.';
...
const TAWKTO_WIDGET_ID = 'YOUR_WIDGET_ID'; // Replace with actual Tawk.to widget ID

export const TawkToChat = () => {
  useEffect(() => {
    // Skip if already loaded or if IDs are not configured
    if (window.Tawk_API || TAWKTO_PROPERTY_ID === 'YOUR_PROPERTY_ID') return;
...
export const WhatsAppButton = ({ phoneNumber = WHATSAPP_NUMBER, message = WHATSAPP_MESSAGE }) => {
